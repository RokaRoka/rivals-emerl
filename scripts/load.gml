...
sprite_change_offset("hurt", 30, 70);
sprite_change_offset("bighurt", 34, 74);
...
sprite_change_offset("dashstart", 34, 82);
sprite_change_offset("dashstop", 32, 82);
sprite_change_offset("dashturn", 34, 82);

sprite_change_offset("jumpstart",28, 78);
sprite_change_offset("jump", 28, 82);
...
sprite_change_offset("parry", 24, 80);
...
sprite_change_offset("ftilt", 24, 80);
sprite_change_offset("dtilt", 24, 80);
sprite_change_offset("utilt", 24, 80);
